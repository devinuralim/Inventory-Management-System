    ...
    <div class="card-clean mb-4 no-print">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-md-8 text-md-end">
                ...
                <a href="{{ route('admin.karyawans.export.pdf') }}" class="btn btn-sm btn-outline-danger rounded-pill px-3"><i class="fas fa-file-pdf me-1"></i></a>
                <a href="{{ route('admin.karyawans.export.csv') }}" class="btn btn-sm btn-outline-success rounded-pill px-3"><i class="fas fa-file-csv me-1"></i></a>
            </div>
        </div>
    </div>
                ...
                @forelse ($karyawans as $index => $karyawan)
                    <tr>
                        ...
                        <td class="text-center no-print">
                            <a href="{{ route('admin.karyawans.edit', $karyawan->id_pegawai) }}" class="btn btn-sm btn-outline-warning rounded-pill me-1" title="Edit"><i class="fas fa-edit"></i></a>
