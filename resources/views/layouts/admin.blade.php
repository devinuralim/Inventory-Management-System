...
<head>
    ...
    <style>
        ...
        /* Header: Kasih jarak 25px atas bawah biar manusiawi */
        .sidebar-header { 
            padding: 25px 20px; 
            text-align: center; 
            flex-shrink: 0; 
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu-wrapper">
            <nav class="nav flex-column">
                ...
                <div class="collapse {{ request()->routeIs('admin.laporan*', 'admin.riwayat*') ? 'show' : '' }}" id="reportingSubmenu">
                    <a href="{{ route('admin.laporan.index') }}" class="nav-link ps-5 {{ request()->routeIs('admin.laporan*') ? 'active' : '' }}">
                        <i class="fas fa-info-circle fa-fw"></i> Kondisi Barang
                    </a>
                    <a href="{{ route('admin.riwayat.index') }}" class="nav-link ps-5 {{ request()->routeIs('admin.riwayat*') ? 'active' : '' }}">
