...
<a class="nav-link d-flex justify-content-between align-items-center 
   {{ request()->routeIs('admin.reporting.*') ? 'active' : '' }}"
   data-bs-toggle="collapse"
   href="#reportingMenu"
   role="button"
   aria-expanded="{{ request()->routeIs('admin.reporting.*') ? 'true' : 'false' }}"
>
    <span>
    ...
    <i class="fas fa-chevron-down arrow 
       {{ request()->routeIs('admin.reporting.*') ? 'rotate' : '' }}"></i>
</a>

<div class="collapse {{ request()->routeIs('admin.reporting.*') ? 'show' : '' }}" id="reportingMenu">
    
    <a href="{{ route('admin.reporting.history') }}" 
       class="nav-link ps-4 {{ request()->routeIs('admin.reporting.history') ? 'active' : '' }}">
        <i class="fas fa-clock me-2"></i> History Peminjaman
    </a>

    <a href="{{ route('admin.reporting.bulanan') }}" 
       class="nav-link ps-4 {{ request()->routeIs('admin.reporting.bulanan') ? 'active' : '' }}">
        <i class="fas fa-calendar-alt me-2"></i> Laporan Bulanan
    </a>

    <a href="{{ route('admin.reporting.rusak') }}" 
       class="nav-link ps-4 {{ request()->routeIs('admin.reporting.rusak') ? 'active' : '' }}">
        <i class="fas fa-exclamation-triangle me-2"></i> Kondisi Barang
    </a>
